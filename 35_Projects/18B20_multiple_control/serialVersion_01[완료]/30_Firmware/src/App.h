...
public:
    ...
    App(DS18B20_Sensor *sensorManager, DataProcessor *dataProcessor, Communicator *comm, void *memoryTester);
...
public: // For testing
    ...
    void checkSensorStatus(); // public으로 이동
    ...
    void displaySensorTable(); // 센서 테이블 표시 메서드 추가
