...
void setup()
{
    ...
    scale.setCalibrate(0, 1137705.60, 0);
    scale.setCalibrate(1, 160397.25, 100);
    scale.setCalibrate(2, 137095.09, 50);
    scale.setCalibrate(3, 183808.04, 150);
    scale.setCalibrate(4, 193131.59, 170);
    scale.setCalibrate(5, 169714.15, 120);
    scale.setCalibrate(6, 197761.25, 180);
    scale.setCalibrate(7, 202503.79, 190);
    scale.setCalibrate(8, 204815.00, 195);
    scale.setCalibrate(9, 205770.54, 197);
    delay(10);
...
void measure(uint8_t cnt)
{
    ...
    Serial.print("UNITS: ");
    Serial.println(scale.get_units(cnt) * 466.768432, 1);
}
