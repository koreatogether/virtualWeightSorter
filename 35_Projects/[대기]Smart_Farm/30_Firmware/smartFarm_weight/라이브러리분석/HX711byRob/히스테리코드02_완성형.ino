...
// Todo 1. 센서 연결 실패 또는 예외 상황에 대한 처리 추가 필요  [ ]
// Todo 2. 무게 단위 표시 필요 [ ]
// Todo 3. 런타임중 켈리브레이션 기능 추가 필요 [ ]
// Todo 4. 런타임중 Gain 변경 기능 추가 필요 [ ]
// Todo 5. 런타임중 Mode 변경 기능 추가 필요 [ ]
// Todo 6. 셋업 함수에서 기능별로 코드를 다시 정리 필요 [ ]
